...
class CentroidTracker(object):
    ...
    def connectObj(self, inputCentroids):

        # grab the set of object IDs and corresponding centroids
        objectIDs = list(self.objects.keys())
        objectCentroids = list(self.objects.values())

        #TODO:Use the Euclidean distance to connect the current object
        #to be tracked with an existing object. If there are more or less
        #new objects than old objects, these must be registered or deregistered
        #4)
